...
export type FindUserInfoByUserOutput = {
  ...
  identity: Scalars['String'];
  /** 부정적 피드백 누름 여부 */
  isNegativeFeedback: Scalars['Boolean'];
  /** 긍정적 피드백 누름 여부 */
  isPositiveFeedback: Scalars['Boolean'];
  /** 레벨 */
  level: Scalars['Int'];
  /** 부정적 피드백 개수 */
  negativeFeedbackCount: Scalars['Int'];
...
export type FindManyCountryCodeQuery = { findManyCountryCode: Array<{ name: string, phone: string, emoji: string, code: string }> };
...
export type FindUserInfoByUserQuery = { findUserInfoByUser: { identity: string, walletAddressKind?: WalletAddressKind | null, walletAddress?: string | null, level: number, connectionDate?: any | null, countryCode: string, positiveFeedbackCount: number, negativeFeedbackCount: number, offerCompleteCount: number, isPositiveFeedback: boolean, isNegativeFeedback: boolean } };
