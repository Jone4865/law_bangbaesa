...
export type FindOneOfferQuery = { findOneOffer: { id: number, coinKind: CoinKind, offerAction: OfferAction, transactionMethod: TransactionMethod, price: number, minAmount: number, maxAmount: number, responseSpeed: number, content?: string | null, createdAt: any, walletAddressKind: WalletAddressKind, walletAddress: string, reservationStatus: ReservationStatus, transactionStatus: TransactionStatus, identity: string, isNewChatMessage?: boolean | null, offerCompleteCount: number, city: { id: number, name: string }, district?: { id: number, name: string } | null } };
